...
@property (nonatomic, readonly, strong) UIButton * __nonnull cameraButton;
@property (nonatomic, readonly, strong) UIButton * __nonnull exitButton;
@property (nonatomic, readonly, strong) UIButton * __nonnull changeCameraButton;
@property (nonatomic, strong) UIImageView * __null_unspecified provisionalImageView;
@property (nonatomic, strong) UIImage * __nonnull provisionalImage;
@property (nonatomic) BOOL cameraInfo;
@property (nonatomic, strong) CIImage * __null_unspecified takeInputImage;
...
@property (nonatomic, readonly, strong) UIButton * __nonnull yukiButton;
@property (nonatomic, readonly, strong) UIButton * __nonnull kurumiButton;
@property (nonatomic, readonly, strong) UIButton * __nonnull yuuriButton;
@property (nonatomic, readonly, strong) UIButton * __nonnull mikiButton;
@property (nonatomic, readonly, strong) UIButton * __nonnull meguneeButton;
@property (nonatomic, strong) UIImage * __nonnull topImage;
- (void)viewDidLoad;
